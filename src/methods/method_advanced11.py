...
# aligning only '<next_word>'

TRESHOLD = 0.01
MIN_PROBABILITY_POINTS = 0.01
...
def get_alignment(hyp, hyp_id, word, next_word):
    ...
    #     print(next_word)
    #     print(alignment)
    #     print(max(sep_id-gap_before_sep, 1))
    #     print(hyp_id)
    #     print(next_word_end)
    return next_word_end, next_word_score
